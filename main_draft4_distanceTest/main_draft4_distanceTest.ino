/*
   ...
   THIS FILE TESTS THE STATE MACHINE WITH ACTUAL DISTANCE SENSORS.
...
#define COUNT_DIST        40                      // Count threshold for the distance sensor sampling/printing frequency
...
void IRQ_handler()
{
  ...
  /* NOTE: NEED TO FIX THIS SECTION BECAUSE WE SHOULD BE POLLING ALL THE SENSORS AT THE SAME RATE
      OR WE NEED TO HAVE MULTIPLE COUNT VARIABLES
  */
