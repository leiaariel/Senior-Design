...
Adafruit_VL6180X vl = Adafruit_VL6180X();         // For distance sensor setup                                URL: https://learn.adafruit.com/adafruit-vl6180x-time-of-flight-micro-lidar-distance-sensor-breakout/wiring-and-test                                   
...
void IRQ_handler()
{
  ...
  /*
   * Read distance and light data
   * If distance sensor isn't working
   * unplug and plug usb for Arduino
   * OR unplug wire connected to power source and connect again
   */
  readDistance();
...
void setupDistance()
{
    ...
    if (vl.begin() == NOT_STARTED) 
    {
      Serial.println("Failed to find sensor");
      while (vl.begin() == NOT_STARTED);
    }
